...
class DatabaseHelper {
  ...
  static void _createDb(Database db, int newVersion) async {
    ...
    await db.insert(tableName,Stage(7,"stage3lv20",[[1,5,770],[0,2,7],[2,2,21],[2,0,3],[0,4,5],[2,4,15],[2,6,3],[4,4,10],[6,4,5],[4,6,2],[4,0,2],[4,2,14],[6,2,7]],[[1,1],[5,1],[5,5]],false).toMap());
    //5
    await db.insert(tableName,Stage(6,"stage3lv20",[[2,3,462],[0,5,210],[5,0,210],[4,4,3],[4,1,15],[1,1,10]],[[4,0],[5,5]],false).toMap());
    await db.insert(tableName,Stage(5,"stage2lv25",[[2,3,462]],[[4,0],[4,1]],false).toMap());
    await db.insert(tableName,Stage(5,"stage3lv25",[[1,2,1155],[2,0,3],[2,4,15]],[[0,1],[4,0]],false).toMap());
    ...
    await db.insert(tableName,Stage(7,"stage3",[[2,2,110],[2,5,14],[4,5,10],[5,2,14],[5,0,2],[4,6,2]],[[0,5],[5,2],[6,6]],false).toMap());
    //15
